...
Version  : 1.1.3
Release  : 106
URL      : https://cran.r-project.org/src/contrib/DBI_1.1.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/DBI_1.1.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655671001
